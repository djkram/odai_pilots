...
ALLOWED_HOSTS = ['lleida.opendai.eu', 'bcn.opendai.eu']
...
STATICFILES_DIRS = (
    ...
    ('media', os.path.join(PROJECT_ROOT,'static')),
)
...
SECRET_KEY = '&amp;gea8_epn&amp;=3=d+ti==5j$z-ncu*lhy&amp;j+o_g2bo2ie_p@usai'
...
LEAFLET_CONFIG = {
    ...
    'PLUGINS': {
            'awesomemarkers': {
            'css': os.path.join(STATIC_URL, 'media/css/leaflet.awesome-markers.css'),
